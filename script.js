...
console.log(` dolphins score is ${dolphinsScore} and koalas score is ${koalasScore}`);
...
if (john.bmi > mark.bmi) {
    console.log(`${john.fullName} BMI ${john.bmi} is higher than ${mark.fullName} BMI `)
}
else {
...
const manjunath = {
    ...
    getsummary: function () {
        return ` ${this.firstName} is ${this.calAge(), this.age} year old ${this.job} , and he has ${this.hasDriverLicense ? 'a' : 'no'} driver license`
    }
};
